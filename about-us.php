        ...
        <div class="container">
            <div class="about-page-text">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="ap-title">
                            <h2>Welcome To Isekai Inn</h2>
                            <p>Our dedicated team is committed to delivering exceptional hospitality and personalized services to ensure that each guest's stay is nothing short of extraordinary. Whether you're here for a romantic getaway, a family vacation, or a business trip, we strive to make your time with us memorable.</p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="video-text">
                        ...
                        <a href="https://www.pexels.com/video/an-empty-beach-resort-7320535/" class="play-btn video-popup"><img
